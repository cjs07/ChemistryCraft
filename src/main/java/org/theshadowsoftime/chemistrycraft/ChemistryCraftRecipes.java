...
public class ChemistryCraftRecipes {
    ...
    static ItemStack nickelIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack copperIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack zincIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack silverIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack cadmiumIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack indiumIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack tungstenIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack tinIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack osmiumIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack iridiumIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack platinumIngotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
    static ItemStack leadnIgotStack = new ItemStack(ChemistryCraftBlocks.oreNickel);
